...
export const Route = createFileRoute("/hostel-admin/furniture/maintenance")({
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              {rows.length === 0 && (
                <tr><td colSpan={7} className="px-3 py-8 text-center text-sm text-muted-foreground">No items under maintenance.</td></tr>
              )}
            </tbody>
          </table>
        </div>
...
function Tile({ icon: Icon, label, value, hint, tint }: { icon: typeof Wrench; label: string; value: string; hint: string; tint: string }) {
  return (
