...
const iconFor = (src: string) => (src === "Hostel" ? BedDouble : src === "Library" ? BookOpen : GraduationCap);
const tintFor = (src: string) => (src === "Hostel" ? "#2563EB" : src === "Library" ? "#0D9488" : "#7B4CED");
      ...
      <div className="rounded-xl border border-border bg-card shadow-sm">
        <ul className="divide-y divide-border">
          {notificationsFeed.map((n) => {
            ...
            return (
              <li key={n.id} className="flex items-start gap-3 p-4 hover:bg-muted/30">
