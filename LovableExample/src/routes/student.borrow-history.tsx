...
export const Route = createFileRoute("/student/borrow-history")({
              ...
              {myBorrowHistory.map((h) => (
                <tr key={h.id} className="hover:bg-muted/30">
                  ...
                  <td className="px-4 py-3">
                    {h.fine > 0 ? (
                      <span className="rounded-full bg-[#EF4444]/10 px-2 py-0.5 text-xs font-medium text-[#EF4444]">₹{h.fine}</span>
                    ) : (
