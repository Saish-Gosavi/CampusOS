...
import { complaints, staff, type Complaint } from "@/lib/hostel-data";
        ...
        <div className="fixed inset-0 z-40 grid place-items-center bg-black/50 p-4" onClick={() => setSelected(null)}>
          <div className="w-full max-w-2xl rounded-xl border border-border bg-card p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mt-5 flex justify-end gap-2">
              ...
              <Button variant="outline" onClick={() => { toast.success(`Assigned to ${assignee || "staff"}`); }}>
                <UserCog className="mr-1.5 h-4 w-4" /> Assign
              </Button>
              <Button className="bg-[#22C55E] text-white hover:bg-[#16A34A]" onClick={() => { toast.success("Complaint marked resolved"); setSelected(null); }}>
