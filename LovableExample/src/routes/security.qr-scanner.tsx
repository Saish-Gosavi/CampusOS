...
export const Route = createFileRoute("/security/qr-scanner")({
...
function QRScannerPage() {
  const [scanned, setScanned] = useState<typeof students[number] | null>(null);
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          {!scanned ? (
            <div className="grid h-72 place-items-center rounded-xl border border-dashed border-border bg-muted/30 text-center">
              <div>
