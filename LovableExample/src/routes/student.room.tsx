...
function Tile({ label, value, icon: Icon, tint }: { label: string; value: string; icon: typeof Building2; tint: string }) {
  return (
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-border bg-card p-5 shadow-sm lg:col-span-2">
          ...
          <ul className="space-y-3">
            {h.roommates.map((r) => (
              <li key={r.enrollment} className="flex items-center gap-3 rounded-lg border border-border p-3">
