...
export const Route = createFileRoute("/inventory-admin/")({
...
const stats = [
  { label: "Total Items", value: "1,160", delta: "+42 this month", trend: "up" as const, icon: Package, tint: "#2563EB" },
  { label: "Low Stock", value: "18", delta: "+3 this week", trend: "down" as const, icon: AlertTriangle, tint: "#EAB308" },
  { label: "Pending Requests", value: "12", delta: "+4 today", trend: "down" as const, icon: ClipboardList, tint: "#7B4CED" },
  { label: "Approved Requests", value: "86", delta: "+11 this week", trend: "up" as const, icon: ClipboardCheck, tint: "#22C55E" },
  { label: "Borrowed Items", value: "24", delta: "+2 today", trend: "up" as const, icon: ArrowRightLeft, tint: "#3B82F6" },
  { label: "Vendors", value: "38", delta: "+1 this month", trend: "up" as const, icon: Truck, tint: "#0D9488" },
];
