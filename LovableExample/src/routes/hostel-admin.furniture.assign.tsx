...
export const Route = createFileRoute("/hostel-admin/furniture/assign")({
...
function AssignFurniturePage() {
  ...
  const submit = () => {
    ...
    toast.success(`${item?.code} assigned to ${stu?.name} · Room ${roomNo}`);
    setItemId(""); setStudentId(""); setRoomNo("");
  };
