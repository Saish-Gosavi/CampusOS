...
export const Route = createFileRoute("/hostel-admin/furniture/replacement")({
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              {rows.length === 0 && (
                <tr><td colSpan={7} className="px-3 py-8 text-center text-sm text-muted-foreground">No replacements on record.</td></tr>
              )}
            </tbody>
          </table>
        </div>
