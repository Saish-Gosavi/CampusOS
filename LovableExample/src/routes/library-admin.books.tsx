...
export const Route = createFileRoute("/library-admin/books")({
  component: BooksPage,
});
  ...
  return (
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      <LibraryPageHeader
        ...
        action={
          <Button className="bg-[#0D9488] hover:bg-[#0b7d72]">
                ...
                <tr key={b.id} className="transition-colors hover:bg-muted/40">
                  <td className="px-3 py-3">
                    <div className="flex items-center gap-3">
                      <span
                        className={`grid h-11 w-8 shrink-0 place-items-center rounded-md bg-gradient-to-br ${
