...
export const Route = createFileRoute("/inventory-admin/items")({
  component: ItemsPage,
});
  ...
  return (
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      <InventoryPageHeader
        ...
        action={
          <Button className="bg-[#2563EB] hover:bg-[#1e4fd1]">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border">
              {current.map((i) => {
                ...
                const barColor =
                  i.status === "Out of Stock" ? "#EF4444" : i.status === "Low Stock" ? "#EAB308" : "#22C55E";
                return (
