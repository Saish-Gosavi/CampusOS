...
export const Route = createFileRoute("/warden/occupancy")({
...
function OccupancyPage() {
  const [block, setBlock] = useState<"All" | "A" | "B" | "C" | "D">("All");
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        {byBlock.map((b) => {
          ...
          return (
            <div key={b.block} className="rounded-xl border border-border bg-card p-5 shadow-sm">
