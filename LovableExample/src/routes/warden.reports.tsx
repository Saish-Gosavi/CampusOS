      ...
      <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {["Student Report", "Occupancy Report", "Leave Report", "Complaint Report", "Visitor Report", "Furniture Report"].map((r) => (
            <button key={r} className="flex items-center justify-between rounded-lg border border-border bg-background px-4 py-3 text-left text-sm transition-colors hover:bg-muted/40">
