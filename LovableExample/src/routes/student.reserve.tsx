...
export const Route = createFileRoute("/student/reserve")({
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {available.map((b) => (
            <div key={b.id} className="flex items-center gap-3 rounded-xl border border-border bg-card p-4 shadow-sm">
