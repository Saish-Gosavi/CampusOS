...
const stats = [
  { label: "Students Inside", value: "104", delta: "+8 vs 1h ago", trend: "up" as const, icon: Users, tint: "#22C55E" },
  { label: "Students Outside", value: "38", delta: "-4 vs 1h ago", trend: "down" as const, icon: DoorOpen, tint: "#F97316" },
  { label: "Visitors Today", value: "18", delta: "+3 vs yesterday", trend: "up" as const, icon: UserCheck, tint: "#06B6D4" },
  { label: "Pending Approvals", value: "4", delta: "2 urgent", trend: "down" as const, icon: BadgeAlert, tint: "#EAB308" },
  { label: "Late Entries", value: "3", delta: "1 flagged", trend: "down" as const, icon: Clock, tint: "#7B4CED" },
  { label: "Late Exits", value: "2", delta: "on watchlist", trend: "down" as const, icon: AlertTriangle, tint: "#EF4444" },
  { label: "Emergency Incidents", value: "1", delta: "open", trend: "down" as const, icon: ShieldAlert, tint: "#DC2626" },
  { label: "Gate Passes Active", value: "12", delta: "3 expiring soon", trend: "up" as const, icon: Ticket, tint: "#2563EB" },
];
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <ChartCard
          ...
          action={
            <Link to="/security/in-out" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#2563EB] hover:bg-[#2563EB]/10">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <ChartCard
          ...
          action={
            <Link to="/security/visitors" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#2563EB] hover:bg-[#2563EB]/10">
              View all <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          }
        >
        ...
        <ChartCard
          ...
          action={
            <Link to="/security/incidents" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#EF4444] hover:bg-[#EF4444]/10">
              View all <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          }
        >
