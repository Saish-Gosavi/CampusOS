...
export const Route = createFileRoute("/hostel-admin/blocks/")({
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={8} className="px-4 py-10 text-center text-sm text-muted-foreground">No blocks match your filters.</td></tr>
              )}
            </tbody>
          </table>
        </div>
