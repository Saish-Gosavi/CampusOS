...
const stats = [
  { label: "Total Students", value: "142", delta: "+6 this week", trend: "up" as const, icon: Users, tint: "#2563EB" },
  { label: "Occupied Rooms", value: "78", delta: "+3 this week", trend: "up" as const, icon: BedDouble, tint: "#7B4CED" },
  { label: "Available Rooms", value: "22", delta: "-2 this week", trend: "down" as const, icon: DoorOpen, tint: "#22C55E" },
  { label: "Pending Leaves", value: "6", delta: "3 urgent", trend: "down" as const, icon: CalendarDays, tint: "#F97316" },
  { label: "Active Complaints", value: "5", delta: "-2 vs last week", trend: "up" as const, icon: MessageSquareWarning, tint: "#EF4444" },
  { label: "Visitors Today", value: "18", delta: "+5 vs yesterday", trend: "up" as const, icon: UserCheck, tint: "#06B6D4" },
  { label: "Furniture Maintenance", value: "9", delta: "2 completed today", trend: "up" as const, icon: Wrench, tint: "#EAB308" },
  { label: "Notices Published", value: "12", delta: "+3 this month", trend: "up" as const, icon: Megaphone, tint: "#0EA5E9" },
];
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <ChartCard
          ...
          action={
            <Link to="/warden/leaves" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#2563EB] hover:bg-[#2563EB]/10">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <ChartCard
          ...
          action={
            <Link to="/warden/complaints" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#2563EB] hover:bg-[#2563EB]/10">
              View all <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          }
        >
        ...
        <ChartCard
          ...
          action={
            <Link to="/warden/visitors" className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#2563EB] hover:bg-[#2563EB]/10">
              View all <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          }
        >
