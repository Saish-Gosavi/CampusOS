...
export const Route = createFileRoute("/hostel-admin/floors/")({
    ...
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        {[
          ...
          <div key={c.label} className="flex items-center justify-between rounded-xl border border-border bg-card p-4 shadow-sm">
            <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              {availableBlocks.map((b) => (
                <option key={b.id} value={b.id}>{b.name} · {hostelName(b.hostelId)}</option>
              ))}
            </select>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filtered.map((f) => {
          ...
          return (
            <div key={f.id} className="group relative overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-shadow hover:shadow-md">
