...
export const Route = createFileRoute("/hostel-admin/")({
  component: HostelDashboard,
});

const stats = [
  { label: "Total Students", value: "265", delta: "+18 this month", trend: "up" as const, icon: Users, tint: "#2563EB" },
  { label: "Total Rooms", value: "180", delta: "4 blocks", trend: "up" as const, icon: DoorClosed, tint: "#7B4CED" },
  { label: "Occupied Rooms", value: "142", delta: "+6 this week", trend: "up" as const, icon: BedDouble, tint: "#3B82F6" },
  { label: "Available Rooms", value: "38", delta: "-4 this week", trend: "down" as const, icon: DoorOpen, tint: "#22C55E" },
  { label: "Pending Complaints", value: "9", delta: "+2 today", trend: "down" as const, icon: MessageSquareWarning, tint: "#EF4444" },
  { label: "Pending Leave Requests", value: "8", delta: "3 awaiting warden", trend: "down" as const, icon: CalendarDays, tint: "#F97316" },
  { label: "Visitors Today", value: "34", delta: "+12 vs yesterday", trend: "up" as const, icon: UserCheck, tint: "#06B6D4" },
  { label: "Fee Collection", value: "₹19.8L", delta: "+8% this month", trend: "up" as const, icon: IndianRupee, tint: "#EAB308" },
];
