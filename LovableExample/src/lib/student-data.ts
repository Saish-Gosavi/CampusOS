// Dummy data for the Student portal (frontend only).
...
export type StudentLeave = {
  id: string;
  type: "Home Visit" | "Medical" | "Personal" | "Event";
  from: string;
  to: string;
  reason: string;
...
export const myLeaves: StudentLeave[] = [
...
export type StudentComplaint = {
  id: string;
  category: "Electrical" | "Plumbing" | "Furniture" | "Cleaning" | "Wi-Fi" | "Other";
...
export const myComplaints: StudentComplaint[] = [
...
export const myVisitors: VisitorRequest[] = [
...
export const myFees: FeeRecord[] = [
  { id: "f1", term: "Semester 6 — Autumn 2026", amount: 42000, dueDate: "2026-08-15", status: "Pending" },
  { id: "f2", term: "Semester 5 — Spring 2026", amount: 42000, dueDate: "2026-01-15", paidOn: "2026-01-08", status: "Paid", receipt: "RCT-24019" },
  { id: "f3", term: "Semester 4 — Autumn 2025", amount: 40000, dueDate: "2025-08-15", paidOn: "2025-08-04", status: "Paid", receipt: "RCT-19821" },
...
export type RoomFurniture = {
  ...
  status: "In Use" | "Under Maintenance" | "Replaced";
};

export const myFurniture: RoomFurniture[] = [
...
export const hostelNoticesFeed: NoticeCard[] = [
...
export const libraryNoticesFeed: NoticeCard[] = [
...
export const myBorrowed: BorrowedBook[] = [
...
export const myBorrowHistory: BorrowHistoryItem[] = [
...
export const myLibraryFines: LibraryFine[] = [
...
export const studentActivities: StudentActivity[] = [
  { id: "a1", title: "Book issued", meta: "Refactoring · Central Library", time: "2 hr ago", icon: BookUp, tint: "#0D9488" },
  ...
  { id: "a4", title: "Visitor checked out", meta: "Neha Mehta · Mother", time: "1 week ago", icon: UserRoundCheck, tint: "#06B6D4" },
  { id: "a5", title: "Fee paid", meta: "Semester 5 · ₹42,000", time: "6 months ago", icon: Gift, tint: "#EAB308" },
  { id: "a6", title: "Book due soon", meta: "Atomic Habits · 6 days left", time: "Today", icon: BookOpen, tint: "#2563EB" },
  { id: "a7", title: "Leave request submitted", meta: "Home Visit — 24 to 27 Jul", time: "Yesterday", icon: CalendarDays, tint: "#F97316" },
];

export type NotificationItem = {
  id: string;
  source: "Hostel" | "Library" | "College";
  title: string;
  body: string;
  time: string;
  unread?: boolean;
...
export const notificationsFeed: NotificationItem[] = [
...
export type StudentDoc = {
  id: string;
  name: string;
  type: "Hostel Receipt" | "Library Receipt" | "Leave Approval" | "Gate Pass";
  issuedOn: string;
  size: string;
};

export const myDocuments: StudentDoc[] = [
