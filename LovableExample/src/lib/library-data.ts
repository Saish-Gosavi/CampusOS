// Dummy data for the Library Admin portal (frontend only).
...
export type Book = {
  ...
  copies: number;
  available: number;
  status: "Available" | "Issued" | "Reserved" | "Out of Stock";
...
export type Donation = {
  id: string;
  donor: string;
  type: "Alumni" | "Faculty" | "Student" | "External";
  books: number;
  date: string;
  status: "Received" | "Cataloged" | "Pending";
};
