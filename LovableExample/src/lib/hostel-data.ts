// Dummy data for the Hostel Admin portal (frontend only).
...
export const hostelActivities: HostelActivity[] = [
  { id: "h1", title: "Student Registered", meta: "Aarav Mehta — CS, Year 2", time: "5 min ago", icon: UserPlus, tint: "#2563EB" },
  { id: "h2", title: "Room Allocated", meta: "Riya Shah → Block A · 204", time: "20 min ago", icon: BedDouble, tint: "#7B4CED" },
  { id: "h3", title: "Complaint Raised", meta: "Water leak — Block B · 118", time: "1 hr ago", icon: MessageSquareWarning, tint: "#EF4444" },
...
export type Student = {
  ...
  cgpa: number;
  father: { name: string; occupation: string; contact: string };
  mother: { name: string; occupation: string; contact: string };
  emergency: { name: string; relation: string; contact: string };
  joinedHostel: string;
};
...
export type Room = {
  ...
  // Extended fields for Room Management
  hostelId?: string;
  blockId?: string;
  floorId?: string;
  floor?: number;
...
export const rooms: Room[] = [
  ...
  { id: "r6", block: "C", number: "215", beds: 2, occupied: 2, status: "Occupied", hostelId: "h2", blockId: "b3", floorId: "fl11", floor: 2, type: "Double", rent: 11000, amenities: ["Wi-Fi", "Attached Bath", "Wardrobe"], description: "Double room with dedicated study nook." },
  ...
  { id: "r8", block: "D", number: "105", beds: 2, occupied: 1, status: "Available", hostelId: "h3", blockId: "b5", floorId: "fl19", floor: 1, type: "Double", rent: 12000, amenities: ["Wi-Fi", "Attached Bath", "Balcony"], description: "Ground-floor double with balcony access." },
  ...
  { id: "r12", block: "C", number: "108", beds: 3, occupied: 3, status: "Occupied", hostelId: "h2", blockId: "b4", floorId: "fl15", floor: 1, type: "Triple", rent: 9000, amenities: ["Wi-Fi", "Study Table"], description: "Ground-floor triple, close to the mess hall." },
];
...
export type Staff = {
  id: string;
  name: string;
  role: "Warden" | "Security" | "Cleaner" | "Cook";
  block: string;
  contact: string;
...
export type Fee = {
  ...
  receipt?: string;
  paidDate?: string;
  method?: "UPI" | "Card" | "Net Banking" | "Cash" | "DD";
};

export const fees: Fee[] = [
  { id: "f1", student: "Aarav Mehta", enrollment: "VP2023CS012", hostel: "Sahyadri Boys", room: "A-204", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Paid", receipt: "RCPT-0012", paidDate: "2026-07-28", method: "UPI" },
  { id: "f2", student: "Riya Shah", enrollment: "VP2022EX045", hostel: "Aravali Girls", room: "G-108", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Pending" },
  { id: "f3", student: "Kabir Verma", enrollment: "VP2021ME101", hostel: "Nilgiri Boys", room: "B-311", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-07-01", status: "Overdue" },
  { id: "f4", student: "Isha Patel", enrollment: "VP2023IT077", hostel: "Aravali Girls", room: "G-215", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Paid", receipt: "RCPT-0013", paidDate: "2026-07-25", method: "Net Banking" },
  { id: "f5", student: "Sara Iyer", enrollment: "VP2024CS220", hostel: "Aravali Girls", room: "G-101", semester: "Aug-Dec 2026", amount: 45000, dueDate: "2026-08-01", status: "Pending" },
  { id: "f6", student: "Vivaan Rao", enrollment: "VP2022ME088", hostel: "Sahyadri Boys", room: "A-118", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Paid", receipt: "RCPT-0014", paidDate: "2026-07-30", method: "Card" },
  { id: "f7", student: "Neha Kulkarni", enrollment: "VP2023CE055", hostel: "Aravali Girls", room: "G-302", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-07-15", status: "Overdue" },
  { id: "f8", student: "Rohan Singh", enrollment: "VP2022EE063", hostel: "Nilgiri Boys", room: "B-209", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Paid", receipt: "RCPT-0015", paidDate: "2026-07-22", method: "UPI" },
  { id: "f9", student: "Meera Joshi", enrollment: "VP2024IT134", hostel: "Aravali Girls", room: "G-410", semester: "Aug-Dec 2026", amount: 45000, dueDate: "2026-08-01", status: "Pending" },
  { id: "f10", student: "Aditya Nair", enrollment: "VP2021ME012", hostel: "Sahyadri Boys", room: "A-005", semester: "Aug-Dec 2026", amount: 42000, dueDate: "2026-08-01", status: "Paid", receipt: "RCPT-0016", paidDate: "2026-07-18", method: "DD" },
];
...
export type FeeStructureItem = {
  ...
  head: string;
  amount: number;
  frequency: "Semester" | "Annual" | "One-time" | "Monthly";
  applicableTo: string;
};

export const feeStructure: FeeStructureItem[] = [
  { id: "fs1", category: "Accommodation", head: "Room Rent (Non-AC)", amount: 28000, frequency: "Semester", applicableTo: "All Boys / Girls" },
  { id: "fs2", category: "Accommodation", head: "Room Rent (AC)", amount: 34000, frequency: "Semester", applicableTo: "AC Blocks" },
  { id: "fs3", category: "Mess", head: "Mess Charges", amount: 12000, frequency: "Semester", applicableTo: "All Residents" },
  { id: "fs4", category: "Security", head: "Refundable Deposit", amount: 10000, frequency: "One-time", applicableTo: "New Admissions" },
  { id: "fs5", category: "Utilities", head: "Electricity & Water", amount: 2000, frequency: "Semester", applicableTo: "All Residents" },
...
export type Complaint = {
  ...
  room: string;
  hostel: string;
  category: "Plumbing" | "Electrical" | "Cleaning" | "Mess" | "Internet" | "Furniture" | "Other";
...
export type NoticeAudience = "All Blocks" | "Block A" | "Block B" | "Block C" | "Block D" | "Wardens" | "Staff";
export type NoticeStatus = "Published" | "Draft" | "Scheduled" | "Expired";
export type NoticeCategory = "General" | "Maintenance" | "Event" | "Emergency" | "Academic";
...
export const feeCollection = [
  { month: "Feb", collected: 1200000 },
  { month: "Mar", collected: 1450000 },
  { month: "Apr", collected: 1620000 },
  { month: "May", collected: 1380000 },
  { month: "Jun", collected: 1740000 },
  { month: "Jul", collected: 1980000 },
];
...
export const leaveRequestOverview = [
  { name: "Pending", value: 8, color: "#EAB308" },
  { name: "Approved", value: 27, color: "#22C55E" },
  { name: "Rejected", value: 4, color: "#EF4444" },
];

export type LeaveType = "Home Visit" | "Medical" | "Family Function" | "Personal" | "Emergency" | "Academic";
...
export type BedType = "Single" | "Bunk-Upper" | "Bunk-Lower";
...
export type VisitorRelation = "Father" | "Mother" | "Sibling" | "Guardian" | "Relative" | "Friend" | "Other";
...
export type InOutPurpose = "Class" | "Personal" | "Medical" | "Home Visit" | "Sports" | "Library" | "Other";
export type InOutStatus = "Inside" | "Outside" | "Returned" | "Late Return" | "Overdue";
...
export type InOutEntry = {
  ...
  inTime?: string;
  status: InOutStatus;
  gate: "Main Gate" | "Side Gate" | "Hostel Gate";
  loggedBy: string;
  method: "QR Scan" | "Manual" | "ID Card";
  remarks?: string;
};

export const inOutEntries: InOutEntry[] = [
  { id: "io1", studentId: "s1", student: "Aarav Mehta", enrollment: "VP2023CS012", hostel: "Boys Hostel", room: "A-204", purpose: "Class", destination: "Academic Block", outDate: "2026-07-22", outTime: "08:45", expectedReturn: "17:00", status: "Outside", gate: "Hostel Gate", loggedBy: "Security · S. Rane", method: "QR Scan" },
  { id: "io2", studentId: "s2", student: "Riya Shah", enrollment: "VP2022EX045", hostel: "Girls Hostel", room: "B-118", purpose: "Library", destination: "Central Library", outDate: "2026-07-22", outTime: "09:10", expectedReturn: "13:00", inDate: "2026-07-22", inTime: "12:45", status: "Returned", gate: "Hostel Gate", loggedBy: "Security · P. Naik", method: "QR Scan" },
  { id: "io3", studentId: "s3", student: "Kabir Verma", enrollment: "VP2021ME101", hostel: "Boys Hostel", room: "C-302", purpose: "Personal", destination: "Sion Market", outDate: "2026-07-22", outTime: "10:20", expectedReturn: "13:30", status: "Outside", gate: "Main Gate", loggedBy: "Security · A. Kadam", method: "Manual" },
  { id: "io4", studentId: "s4", student: "Isha Patel", enrollment: "VP2023IT077", hostel: "Girls Hostel", room: "A-210", purpose: "Medical", destination: "Sion Hospital", outDate: "2026-07-22", outTime: "07:30", expectedReturn: "11:00", inDate: "2026-07-22", inTime: "11:35", status: "Late Return", gate: "Main Gate", loggedBy: "Security · P. Naik", method: "ID Card", remarks: "Returned 35 min late — traffic." },
  { id: "io5", studentId: "s5", student: "Neel Deshmukh", enrollment: "VP2020CV019", hostel: "Boys Hostel", room: "D-105", purpose: "Sports", destination: "District Stadium", outDate: "2026-07-22", outTime: "06:00", expectedReturn: "09:30", inDate: "2026-07-22", inTime: "09:20", status: "Returned", gate: "Side Gate", loggedBy: "Security · S. Rane", method: "QR Scan" },
  { id: "io6", studentId: "s6", student: "Meera Joshi", enrollment: "VP2023CS021", hostel: "Girls Hostel", room: "A-112", purpose: "Class", destination: "Academic Block", outDate: "2026-07-22", outTime: "08:50", expectedReturn: "17:00", status: "Outside", gate: "Hostel Gate", loggedBy: "Security · P. Naik", method: "QR Scan" },
  { id: "io7", studentId: "s7", student: "Sara Iyer", enrollment: "VP2022CS033", hostel: "Girls Hostel", room: "A-101", purpose: "Personal", destination: "Bandra", outDate: "2026-07-22", outTime: "11:00", expectedReturn: "15:00", status: "Outside", gate: "Main Gate", loggedBy: "Security · A. Kadam", method: "Manual" },
  { id: "io8", studentId: "s8", student: "Vivaan Rao", enrollment: "VP2021EC088", hostel: "Boys Hostel", room: "C-215", purpose: "Home Visit", destination: "Andheri West", outDate: "2026-07-21", outTime: "18:00", expectedReturn: "22:00", status: "Overdue", gate: "Main Gate", loggedBy: "Security · S. Rane", method: "QR Scan", remarks: "Not returned overnight — flagged." },
  { id: "io9", studentId: "s1", student: "Aarav Mehta", enrollment: "VP2023CS012", hostel: "Boys Hostel", room: "A-204", purpose: "Library", destination: "Central Library", outDate: "2026-07-21", outTime: "19:00", expectedReturn: "22:00", inDate: "2026-07-21", inTime: "21:50", status: "Returned", gate: "Hostel Gate", loggedBy: "Security · N. Salunke", method: "QR Scan" },
  { id: "io10", studentId: "s3", student: "Kabir Verma", enrollment: "VP2021ME101", hostel: "Boys Hostel", room: "C-302", purpose: "Personal", destination: "Thane West", outDate: "2026-07-20", outTime: "10:00", expectedReturn: "20:00", inDate: "2026-07-20", inTime: "22:30", status: "Late Return", gate: "Main Gate", loggedBy: "Security · N. Salunke", method: "Manual", remarks: "Late return — informed warden." },
  { id: "io11", studentId: "s4", student: "Isha Patel", enrollment: "VP2023IT077", hostel: "Girls Hostel", room: "A-210", purpose: "Class", destination: "Academic Block", outDate: "2026-07-20", outTime: "08:45", expectedReturn: "17:00", inDate: "2026-07-20", inTime: "16:50", status: "Returned", gate: "Hostel Gate", loggedBy: "Security · P. Naik", method: "QR Scan" },
  { id: "io12", studentId: "s6", student: "Meera Joshi", enrollment: "VP2023CS021", hostel: "Girls Hostel", room: "A-112", purpose: "Sports", destination: "College Ground", outDate: "2026-07-19", outTime: "16:00", expectedReturn: "18:30", inDate: "2026-07-19", inTime: "18:25", status: "Returned", gate: "Side Gate", loggedBy: "Security · A. Kadam", method: "QR Scan" },
];

export type FurnitureCategory = "Bed" | "Study Table" | "Chair" | "Wardrobe" | "Fan" | "Cupboard" | "Mattress" | "Desk Lamp" | "Curtain" | "Shelf";
export type FurnitureCondition = "Good" | "Fair" | "Damaged";
export type FurnitureStatus = "In Use" | "In Storage" | "Assigned" | "Under Maintenance" | "Replaced" | "Retired";
