// Dummy data for the Inventory Admin portal (frontend only).
...
export const inventoryActivities: InventoryActivity[] = [
  { id: "i1", title: "New Item Added", meta: "Dell OptiPlex 7010 · 12 units", time: "8 min ago", icon: PackagePlus, tint: "#2563EB" },
  { id: "i2", title: "Request Approved", meta: "PR-00184 · Computer Dept", time: "35 min ago", icon: ClipboardCheck, tint: "#22C55E" },
  { id: "i3", title: "Goods Received", meta: "GRN-00092 · Whiteboard markers", time: "1 hr ago", icon: Truck, tint: "#7B4CED" },
...
export const inventoryItems: InventoryItem[] = [
  { id: "it1", name: "Dell OptiPlex 7010", category: "Electronics", sku: "SKU-EL-0012", available: 24, minStock: 10, unit: "units", location: "Store A · Rack 3", status: "In Stock" },
  ...
  { id: "it3", name: "A4 Paper (500 sheets)", category: "Stationery", sku: "SKU-ST-0104", available: 12, minStock: 40, unit: "reams", location: "Store B · Rack 1", status: "Low Stock" },
  { id: "it4", name: "Whiteboard Markers", category: "Stationery", sku: "SKU-ST-0201", available: 180, minStock: 60, unit: "pcs", location: "Store B · Rack 2", status: "In Stock" },
...
export type GoodsReceipt = {
  ...
  quantity: number;
  receivedOn: string;
  status: "Received" | "Inspected" | "Pending Inspection";
};
...
export const departmentSpend = [
  { name: "Computer", value: 285000 },
  { name: "EXTC", value: 210000 },
  { name: "Mechanical", value: 178000 },
  { name: "Civil", value: 134000 },
  { name: "Chemistry", value: 96000 },
  { name: "Admin", value: 152000 },
];

export const borrowingTrend = [
