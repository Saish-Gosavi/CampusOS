...
import type { BreadcrumbItem } from "./SecurityBreadcrumbs";
...
export function SecurityPagePlaceholder({ title, description, icon, tint, breadcrumbs }: Props) {
  return (
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      <SecurityPageHeader title={title} description={description} icon={icon} tint={tint} breadcrumbs={breadcrumbs} />
