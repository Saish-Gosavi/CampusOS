...
const notifications = [
  { icon: CalendarDays, tint: "#F97316", title: "Leave request pending", meta: "Home Visit · 24–27 Jul" },
  { icon: BookOpen, tint: "#2563EB", title: "Book due in 2 days", meta: "Atomic Habits · due 28 Jul" },
  { icon: Megaphone, tint: "#0EA5E9", title: "Fire safety drill", meta: "Wednesday, 6 PM · Assembly Point" },
];
