...
import type { NoticeFormValues } from "@/components/hostel/NoticeForm";

interface Props {
  values: NoticeFormValues | null;
  onClose: () => void;
}

export function NoticePreviewDialog({ values, onClose }: Props) {
  return (
    <Dialog open={!!values} onOpenChange={(o) => !o && onClose()}>
