...
import type { BreadcrumbItem } from "./InventoryBreadcrumbs";
...
export function InventoryPagePlaceholder({ title, description, icon, tint, breadcrumbs }: Props) {
  return (
    <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      <InventoryPageHeader title={title} description={description} icon={icon} tint={tint} breadcrumbs={breadcrumbs} />
