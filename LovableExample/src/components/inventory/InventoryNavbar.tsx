...
const notifications = [
  { icon: AlertTriangle, tint: "#EF4444", title: "Low stock: A4 Paper", meta: "12 reams · reorder soon" },
  { icon: ClipboardList, tint: "#EAB308", title: "New procurement request", meta: "PR-00184 · Computer Dept" },
  { icon: Truck, tint: "#2563EB", title: "Goods receipt pending inspection", meta: "GRN-00094 · SciLab" },
];
