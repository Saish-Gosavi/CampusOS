...
const notifications = [
  { icon: AlertTriangle, tint: "#EF4444", title: "Low stock: A4 Paper", meta: "12 reams \xB7 reorder soon" },
  { icon: ClipboardList, tint: "#EAB308", title: "New procurement request", meta: "PR-00184 \xB7 Computer Dept" },
  { icon: Truck, tint: "#2563EB", title: "Goods receipt pending inspection", meta: "GRN-00094 \xB7 SciLab" }
];
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="ml-1 flex items-center gap-2 rounded-lg py-1 pl-1 pr-2 transition-colors hover:bg-muted">
              <span className="grid h-8 w-8 place-items-center rounded-full bg-gradient-to-br from-[#2563EB] to-[#1e40af] text-sm font-semibold text-white">
                IA
              </span>
              <span className="hidden text-left leading-tight sm:block">
                <span className="block text-sm font-semibold text-foreground">Inventory Admin</span>
                <span className="block text-xs text-muted-foreground">inventory@vppcoe.edu</span>
              </span>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuItem asChild>
              <Link to="/inventory-admin/profile">
                <UserCircle2 className="mr-2 h-4 w-4" /> Profile
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link to="/inventory-admin/settings">
