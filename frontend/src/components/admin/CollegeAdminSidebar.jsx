...
const mainItems = [
  { title: "Dashboard", url: "/admin", exact: true, icon: LayoutDashboard },
  { title: "Hostels", url: "/hostel-admin", icon: DoorClosed },
  { title: "Library", url: "/library-admin", icon: BookOpen },
  { title: "Inventory", url: "/inventory-admin", icon: Package },
  { title: "Staff Directory", url: "/admin/staff", icon: Users }
];

const insightItems = [
  { title: "Reports", url: "/admin/reports", icon: BarChart3 },
  { title: "Global Notices", url: "/admin/notices", icon: Megaphone },
];
          ...
          <div className="flex items-center gap-2 px-1 py-1.5">
            ...
            {!collapsed && (
              <div className="min-w-0">
                <p className="truncate text-sm font-semibold text-white">{user?.college?.name || "CampusOS"}</p>
                <p className="truncate text-xs text-slate-400">College Admin</p>
              </div>
            )}
          </div>
        </SidebarHeader>
