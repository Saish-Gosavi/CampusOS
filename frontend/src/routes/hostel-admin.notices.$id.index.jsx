...
const Route = createFileRoute("/hostel-admin/notices/$id/")({
  loader: ({ params }) => {
...
function PreviewNoticePage() {
  ...
  >
            ...
            {notice.pinned && <span className="inline-flex items-center gap-1 rounded-full bg-white/15 px-2 py-1 text-xs">
  ...
  >
            ...
            {notice.attachment && <div className="flex items-center justify-between rounded-lg border border-border bg-muted/30 px-4 py-3">
                <div className="flex items-center gap-3">
