...
const Route = createFileRoute("/hostel-admin/students/$id")({
  loader: ({ params }) => {
    ...
    /* ID card preview */
        ...
        <div className="flex flex-col gap-6">
          ...
          <Panel title="Guardian Details" icon={Users2}>
            <Row icon={Users2} label="Father" value={`${s.father.name} \xB7 ${s.father.occupation}`} />
            <Row icon={Phone} label="Father Contact" value={s.father.contact} />
            <Row icon={Users2} label="Mother" value={`${s.mother.name} \xB7 ${s.mother.occupation}`} />
