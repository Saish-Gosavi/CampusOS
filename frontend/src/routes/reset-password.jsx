...
function ResetPasswordPage() {
  ...
  />
        ...
        {password.length > 0 && <div className="space-y-3 rounded-lg border border-border bg-secondary/40 p-3">
  ...
  />
        ...
        {confirm && confirm === password && <p className="flex items-center gap-1.5 text-xs text-success">
