...
const stats = [
  { label: "Total Books", value: "4,820", delta: "+64 this month", trend: "up", icon: BookOpen, tint: "#0D9488" },
  { label: "Available Books", value: "3,412", delta: "+12 today", trend: "up", icon: BookCheck, tint: "#22C55E" },
  { label: "Issued Books", value: "1,148", delta: "+38 this week", trend: "up", icon: BookUp, tint: "#2563EB" },
  { label: "Reserved Books", value: "124", delta: "+9 this week", trend: "up", icon: BookMarked, tint: "#7B4CED" },
  { label: "Overdue Books", value: "42", delta: "-6 vs last week", trend: "up", icon: AlarmClock, tint: "#EF4444" },
  { label: "Total Members", value: "2,315", delta: "+52 this month", trend: "up", icon: Users, tint: "#EAB308" }
];
const quickActions = [
...
function LibraryDashboard() {
  ...
  />
    ...
    action={<button className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-[#0D9488] hover:bg-[#0D9488]/10">
            View all <ArrowRight className="h-3.5 w-3.5" />
          </button>}
  >
        <ol className="relative space-y-4 border-l border-dashed border-border pl-5">
          {libraryActivities.map((item) => <li key={item.id} className="relative">
              <span
