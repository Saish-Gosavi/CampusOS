...
const Route = createFileRoute("/security/settings")({
...
function SettingsPage() {
  return <div className="mx-auto flex max-w-[1600px] flex-col gap-6">
      <SecurityPageHeader
    title="Settings"
    description="Personalise your security portal experience."
    icon={Settings}
    tint={TINT}
  ...
  />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Section icon={Moon} title="Theme" description="Switch between light and dark mode.">
        ...
        <Section icon={Languages} title="Language" description="Choose your preferred display language.">
        ...
        <Section icon={Bell} title="Notifications" description="Manage in-app and email alerts.">
          <label className="flex items-center justify-between gap-3 rounded-lg border border-border bg-muted/30 p-3">
            <span className="text-sm text-foreground">Incident alerts</span>
          ...
          <label className="mt-2 flex items-center justify-between gap-3 rounded-lg border border-border bg-muted/30 p-3">
            <span className="text-sm text-foreground">Visitor approvals</span>
            <input type="checkbox" defaultChecked className="h-4 w-4 accent-[#2563EB]" />
          </label>
          <label className="mt-2 flex items-center justify-between gap-3 rounded-lg border border-border bg-muted/30 p-3">
            <span className="text-sm text-foreground">Shift summary email</span>
