...
const Route = createFileRoute("/inventory-admin/approvals")({
...
function ApprovalsPage() {
  ...
  />
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {pending.map((r) => <div key={r.id} className="rounded-xl border border-border bg-card p-5 shadow-sm">
        ...
        {pending.length === 0 && <div className="col-span-full grid place-items-center rounded-xl border border-dashed border-border bg-card p-12 text-sm text-muted-foreground">
